...
@interface CreativeMindViewController : UIViewController <UIPickerViewDelegate, UIPickerViewDataSource>
{
    ...
    BOOL fiveMinuteCreativeMindExists;
    BOOL fifteenMinuteCreativeMindExists;
    BOOL thirtyMinuteCreativeMindExists;
