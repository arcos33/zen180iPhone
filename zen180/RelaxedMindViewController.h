...
@interface RelaxedMindViewController : UIViewController <UIPickerViewDelegate, UIPickerViewDataSource>
{
    ...
    BOOL fiveMinuteRelaxedMindExists;
    BOOL fifteenMinuteRelaxedMindExists;
    BOOL thirtyMinuteRelaxedMindExists;
